...
CategorieData categorieDataFromJson(String str) => CategorieData.fromJson(json.decode(str));

String categorieDataToJson(CategorieData data) => json.encode(data.toJson());
